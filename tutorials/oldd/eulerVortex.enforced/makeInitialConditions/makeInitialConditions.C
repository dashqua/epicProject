...
#include "createDyMControls.H"
  ...
  (
   ...
   dimensionedScalar("p", dimensionSet(1,-1,-2,0,0,0,0), 3)
   );
  ...
  rho.boundaryFieldRef().set(topPatchID,fvPatchField<scalar>::New("fixedValue", mesh.boundary()[topPatchID], rho));

  const label& bottomPatchID = bm.findPatchID("bottom_cyc");
  U.boundaryFieldRef().set(bottomPatchID,fvPatchField<vector>::New("fixedValue", mesh.boundary()[bottomPatchID], U));
  p.boundaryFieldRef().set(bottomPatchID,fvPatchField<scalar>::New("fixedValue", mesh.boundary()[bottomPatchID], p));
  T.boundaryFieldRef().set(bottomPatchID,fvPatchField<scalar>::New("fixedValue", mesh.boundary()[bottomPatchID], T));
  rho.boundaryFieldRef().set(bottomPatchID,fvPatchField<scalar>::New("fixedValue", mesh.boundary()[bottomPatchID], rho));
  ...
  p.boundaryFieldRef().set(inletPatchID,fvPatchField<scalar>::New("fixedValue", mesh.boundary()[inletPatchID], p));
  T.boundaryFieldRef().set(inletPatchID,fvPatchField<scalar>::New("fixedValue", mesh.boundary()[inletPatchID], T));
  rho.boundaryFieldRef().set(inletPatchID,fvPatchField<scalar>::New("fixedValue", mesh.boundary()[inletPatchID], rho));
  ...
  rho.boundaryFieldRef().set(outletPatchID,fvPatchField<scalar>::New("fixedValue", mesh.boundary()[outletPatchID], rho));
  */
  T.write();
  p.write();
